...
(function () {
    ...
    function _getRecorderWorkerUrl() {
        ...
        return getBlobUrl(new Blob([_getFuntionBody(_recorderWorkerJs)], {type: 'userInput/javascript'}));
    }
...
(function () {
    ...
    TTS.prototype.tts = function (text, onended, lang) {
        ...
        xhr.open('GET', 'https://' + _this.server + '/api/tts?access_token=' + _this.access_token + '&lang=' + lang + '&userInput=' + text, true);
